...
namespace SmtpNotification
{
    ...
    {
        public const string Pattern = @"[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?";
        ...
        private static Regex _regex = new Regex(Pattern, RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture);
        ...
        {
            return ValidateEmail(email, null) == ValidationResult.Success;
        }
        
        public Task Validate(Kernel.Validation.ValidationContext context)
        {
